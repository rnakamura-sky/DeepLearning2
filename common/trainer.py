        ...
        for epoch in range(max_epoch):
            ...
            for iters in range(max_iters):
                ...
                if (eval_interval is not None) and (iters % eval_interval) == 0:
                    ...
                    print(f'| epoch {self.current_epoch+1} | iter {iters+1} / {max_iters} | time {elapsed_time}[s] | loss {avg_loss:.2f} |')
        ...
        for epoch in range(max_epoch):
            for iters in range(max_iters):
                ...
                if (eval_interval is not None) and (iters % eval_interval) == 0:
                    ...
                    elapsed_time = time.time() - start_time
                    print(f'| epoch {self.current_epoch+1:5d} | iter {iters+1:5d} / {max_iters:5d} | time {elapsed_time}[s] | perplexity {ppl:.2f} |')
